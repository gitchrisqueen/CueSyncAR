...
#ifndef AREXPERIENCE_SWIFT_H
#define AREXPERIENCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARExperience",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class ARAnchor;
@class ARCamera;
SWIFT_CLASS("_TtC12ARExperience20ARSessionCoordinator")
@interface ARSessionCoordinator : NSObject <ARSessionDelegate>
...
/// works from <code>TrackingCondition</code>, which is pure and tested on Linux.
